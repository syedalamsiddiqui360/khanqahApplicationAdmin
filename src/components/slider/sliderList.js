...
function SliderList(props) {
    ...
    const callSliderApi = (e) => {
        axios.post('http://localhost:9000/slider/get_by_limit',{
            offset: offset,
            limit: limit,
        })
        .then((res) => {
    ...
    const deleteType = () => {
        axios.delete('http://localhost:9000/slider/delete/'+id)
        .then((res) => {
            console.log(res);
            setShow(false);
    ...
    const getOneType = (id) => {
        axios.post('http://localhost:9000/slider/get_by_id/'+id)
        .then((res) => {
            let data = res.data;
            console.log(data);
            handleData(data);
